...
# args:
# 	$1: failOnDebit (bool):
# 		if true, this will make the DebugFeeCurrency.DebitFees() call fail with a revert
# 	$2: failOnCredit (bool)
# 		if true, this will make the DebugFeeCurrency.CreditFees() call fail with a revert
# 	$3: highGasOnCredit (bool)
# 		if true, this will make the DebugFeeCurrency.CreditFees() call use
...
# 		expected RPC return-error regex to grep for, use "null", "" or unset value if no error is assumed.
